...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from 224114235, Shreya Bista");
		...
		System.out.println("Navigate to Google Page : Success");
		sleep(2);
        ...
        System.out.println("Window size resized to 640x480");
        ...
        Dimension newSize = new Dimension(1280, 960);
        driver.manage().window().setSize(newSize);
        System.out.println("Window size doubled to 1280x960");
